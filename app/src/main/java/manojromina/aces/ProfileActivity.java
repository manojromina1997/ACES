...
public class ProfileActivity extends AppCompatActivity {
    ...
    private ImageButton mProfilePagePic;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mProfilePagePic = (ImageButton)findViewById(R.id.profilePagePic);
            ...
            protected void populateViewHolder(MainActivity.BlogViewHolder viewHolder, Blog model, int position) {
                ...
                viewHolder.mView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        Intent blogSingleIntent = new Intent(ProfileActivity.this,SingleBlogActivity.class);
